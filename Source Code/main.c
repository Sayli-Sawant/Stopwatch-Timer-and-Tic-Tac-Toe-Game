...
void myHandler(void){
     ...
     if (GPIO_PORTF_MIS_R & 0x10){
                         // switch 1
         if(device_stop==0 && device_pause==1)
         {
             console_resume();
         }
         else if(device_stop==0 && device_pause==0)
         {
             console_pause();
         }
   ...
   // end segment display code.
         ...
         if(device_stop==0 && device_pause==0)
          {
              console_stop();
          }
          else if(device_stop==1 && device_pause==0)
          {
              console_start();
          }
 ...
 // send data that is received
    ...
    console_cmd_buffer[ci++]= c;
        ...
        if(mystringcompare(cmd , "color")==0){
            ...
            if(device_stop==1 && device_pause==0)
            {
                console_start();
            }
                }
